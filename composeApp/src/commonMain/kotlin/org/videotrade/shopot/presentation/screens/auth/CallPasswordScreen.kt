            ...
            Box(
                ...
                Column(
                    ...
                    Column(
                        ...
                        verticalArrangement = Arrangement.SpaceBetween, // Распределяет элементы равномерно
                        horizontalAlignment = Alignment.CenterHorizontally
                    ) {
                        Column(
                            modifier = Modifier
                                .fillMaxWidth()
                                .weight(1f), // Занимает всю доступную высоту, оставляя место для нижнего текста
                            horizontalAlignment = Alignment.CenterHorizontally
                        ) {
                            Image(
                            ...
                            if (!isCallPasswordSuccess) {
                                ...
                                Image(
                                    modifier = Modifier
                                        .size(width = 195.dp, height = 146.dp),
                        ...
                        Text(
                            modifier = Modifier
                                .fillMaxWidth()
                                .padding(bottom = 50.dp) // Немного отступа от нижнего края
