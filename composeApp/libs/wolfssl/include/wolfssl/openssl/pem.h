...
WOLFSSL_API
        WOLFSSL_RSA
*
wolfSSL_PEM_read_bio_RSAPrivateKey(WOLFSSL_BIO
* bio,
WOLFSSL_RSA **rsa, wc_pem_password_cb
* cb,
void *pass
);
...
WOLFSSL_API
        WOLFSSL_RSA
*
wolfSSL_PEM_read_bio_RSA_PUBKEY(WOLFSSL_BIO
* bio,
WOLFSSL_RSA **rsa,
        wc_pem_password_cb
* cb,
...
WOLFSSL_API
        WOLFSSL_EC_GROUP
*
wolfSSL_PEM_read_bio_ECPKParameters(WOLFSSL_BIO
* bio,
...
WOLFSSL_API
        WOLFSSL_RSA
*
wolfSSL_PEM_read_RSAPrivateKey(XFILE
fp,
WOLFSSL_RSA **rsa,
        wc_pem_password_cb
* cb,
...
WOLFSSL_API
        WOLFSSL_RSA
*
wolfSSL_PEM_read_RSAPublicKey(XFILE
fp,
WOLFSSL_RSA **x,
        wc_pem_password_cb
*cb,
...
WOLFSSL_API
int wolfSSL_PEM_write_RSAPublicKey(XFILE
fp,
WOLFSSL_RSA *key
);

WOLFSSL_API
int wolfSSL_PEM_write_RSA_PUBKEY(XFILE
fp,
WOLFSSL_RSA *x
);
...
WOLFSSL_API
        WOLFSSL_RSA
*
wolfSSL_PEM_read_RSA_PUBKEY(XFILE
fp,
WOLFSSL_RSA **rsa,
        wc_pem_password_cb
* cb,
...
WOLFSSL_API
        WOLFSSL_DSA
*
wolfSSL_PEM_read_bio_DSAPrivateKey(WOLFSSL_BIO
* bio,
WOLFSSL_DSA **dsa,
        wc_pem_password_cb
* cb,
...
WOLFSSL_API
        WOLFSSL_DSA
*
wolfSSL_PEM_read_bio_DSA_PUBKEY(WOLFSSL_BIO
* bio,
WOLFSSL_DSA **dsa,
        wc_pem_password_cb
* cb,
...
#if !defined(NO_FILESYSTEM)
WOLFSSL_API
int wolfSSL_PEM_write_DSAPrivateKey(XFILE
fp,
WOLFSSL_DSA *dsa,
const WOLFSSL_EVP_CIPHER *enc,
unsigned char *kstr,
...
WOLFSSL_API
int wolfSSL_PEM_write_DSA_PUBKEY(XFILE
fp,
WOLFSSL_DSA *x
);
#endif /* NO_FILESYSTEM */
...
WOLFSSL_API
        WOLFSSL_EC_KEY
*
wolfSSL_PEM_read_bio_ECPrivateKey(WOLFSSL_BIO
* bio,
WOLFSSL_EC_KEY **ec,
        wc_pem_password_cb
* cb,
...
#if !defined(NO_FILESYSTEM)
WOLFSSL_API
int wolfSSL_PEM_write_ECPrivateKey(XFILE
fp,
WOLFSSL_EC_KEY *key,
const WOLFSSL_EVP_CIPHER *enc,
unsigned char *kstr,
...
WOLFSSL_API
int wolfSSL_PEM_write_EC_PUBKEY(XFILE
fp,
WOLFSSL_EC_KEY *key
);
#endif
...
WOLFSSL_API
        WOLFSSL_EC_KEY
*
wolfSSL_PEM_read_bio_EC_PUBKEY(WOLFSSL_BIO
* bio,
WOLFSSL_EC_KEY **ec,
        wc_pem_password_cb
* cb,
...
WOLFSSL_API
        WOLFSSL_EVP_PKEY
*
wolfSSL_PEM_read_bio_PrivateKey(WOLFSSL_BIO
* bio,
...
WOLFSSL_API
        WOLFSSL_EVP_PKEY
*
wolfSSL_PEM_read_bio_PUBKEY(WOLFSSL_BIO
* bio,
WOLFSSL_EVP_PKEY **key,
        wc_pem_password_cb
*cb,
...
WOLFSSL_API
        WOLFSSL_EVP_PKEY
*
wolfSSL_PEM_read_PrivateKey(XFILE
fp,
WOLFSSL_EVP_PKEY **x,
        wc_pem_password_cb
*cb,
...
WOLFSSL_API
int wolfSSL_PEM_write_X509(XFILE
fp,
WOLFSSL_X509 *x
);
WOLFSSL_API
int wolfSSL_PEM_write_DHparams(XFILE
fp,
WOLFSSL_DH *dh
);
#endif /* NO_FILESYSTEM */
