...
wolfSSL_RSA_new_ex(void *heap, int devId);
...
WOLFSSL_API int wolfSSL_RSA_generate_key_ex(WOLFSSL_RSA * rsa, int
bits,
WOLFSSL_BIGNUM *bn,
void *cb
);
...
WOLFSSL_API WOLFSSL_RSA_METHOD
*

wolfSSL_RSA_meth_new(const char *name, int flags);
...
WOLFSSL_API const WOLFSSL_RSA_METHOD
*

wolfSSL_RSA_get_method(const WOLFSSL_RSA *rsa);

WOLFSSL_API const WOLFSSL_RSA_METHOD
*

wolfSSL_RSA_get_default_method(void);
...
WOLFSSL_API void wolfSSL_RSA_set_flags(WOLFSSL_RSA * r, int
flags);
WOLFSSL_API void wolfSSL_RSA_clear_flags(WOLFSSL_RSA * r, int
flags);
...
WOLFSSL_API WOLFSSL_RSA
*
wolfSSL_RSAPublicKey_dup(WOLFSSL_RSA
*rsa);

WOLFSSL_API void *wolfSSL_RSA_get_ex_data(const WOLFSSL_RSA *rsa, int idx);

WOLFSSL_API int wolfSSL_RSA_set_ex_data(WOLFSSL_RSA * rsa, int
idx,
void *data
);
