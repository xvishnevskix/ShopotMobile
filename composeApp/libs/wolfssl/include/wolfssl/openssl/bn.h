...
WOLFSSL_API int wolfSSL_BN_sub(WOLFSSL_BIGNUM * r,
...
WOLFSSL_API int wolfSSL_BN_gcd(WOLFSSL_BIGNUM* r, WOLFSSL_BIGNUM* a,
                               WOLFSSL_BIGNUM* b, WOLFSSL_BN_CTX* ctx);
#endif
WOLFSSL_API int wolfSSL_BN_mod(WOLFSSL_BIGNUM * r,
const WOLFSSL_BIGNUM *a,
const WOLFSSL_BIGNUM *b,
...
const WOLFSSL_BIGNUM *m, WOLFSSL_BN_CTX
*ctx);
...
const WOLFSSL_BIGNUM *m, WOLFSSL_BN_CTX
*ctx);
WOLFSSL_API const WOLFSSL_BIGNUM
*

wolfSSL_BN_value_one(void);
...
wolfSSL_BN_bin2bn(const unsigned char *str, int len,
                  WOLFSSL_BIGNUM *ret);

WOLFSSL_API int wolfSSL_mask_bits(WOLFSSL_BIGNUM * bn, int
n);

WOLFSSL_API int wolfSSL_BN_pseudo_rand(WOLFSSL_BIGNUM * bn, int
bits,
int top,
int bottom
);
WOLFSSL_API int wolfSSL_BN_rand_range(WOLFSSL_BIGNUM * r,
const WOLFSSL_BIGNUM *range
);
WOLFSSL_API int wolfSSL_BN_rand(WOLFSSL_BIGNUM * bn, int
bits,
int top,
int bottom
);
...
WOLFSSL_API int wolfSSL_BN_hex2bn(WOLFSSL_BIGNUM * *bn,
const char *str
);
...
wolfSSL_BN_dup(const WOLFSSL_BIGNUM *bn);

WOLFSSL_API WOLFSSL_BIGNUM
*
wolfSSL_BN_copy(WOLFSSL_BIGNUM
* r,
const WOLFSSL_BIGNUM *bn
);

WOLFSSL_API int wolfSSL_BN_dec2bn(WOLFSSL_BIGNUM * *bn,
const char *str
);

WOLFSSL_API char *wolfSSL_BN_bn2dec(const WOLFSSL_BIGNUM *bn);

WOLFSSL_API int wolfSSL_BN_lshift(WOLFSSL_BIGNUM * r,
const WOLFSSL_BIGNUM *bn,
int n
);
WOLFSSL_API int wolfSSL_BN_add_word(WOLFSSL_BIGNUM * bn, WOLFSSL_BN_ULONG
w);
WOLFSSL_API int wolfSSL_BN_sub_word(WOLFSSL_BIGNUM * bn, WOLFSSL_BN_ULONG
w);
WOLFSSL_API int wolfSSL_BN_set_bit(WOLFSSL_BIGNUM * bn, int
n);
WOLFSSL_API int wolfSSL_BN_clear_bit(WOLFSSL_BIGNUM * bn, int
n);
WOLFSSL_API int wolfSSL_BN_set_word(WOLFSSL_BIGNUM * bn, WOLFSSL_BN_ULONG
w);
...
#endif
WOLFSSL_API int wolfSSL_BN_rshift(WOLFSSL_BIGNUM * r,
const WOLFSSL_BIGNUM *bn,
int n
);
WOLFSSL_API WOLFSSL_BIGNUM
*
wolfSSL_BN_CTX_get(WOLFSSL_BN_CTX
*ctx);
