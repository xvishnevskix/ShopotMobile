...
WOLFSSL_API
        size_t
wolfSSL_EC_get_builtin_curves(WOLFSSL_EC_BUILTIN_CURVE
*r,
size_t nitems
);
...
wolfSSL_EC_KEY_dup(const WOLFSSL_EC_KEY *src);
...
wolfSSL_EC_POINT_point2oct(const WOLFSSL_EC_GROUP *group,
                           const WOLFSSL_EC_POINT *p,
                           int form,
...
WOLFSSL_API
        WOLFSSL_EC_KEY
*
wolfSSL_o2i_ECPublicKey(WOLFSSL_EC_KEY
**a,
...
WOLFSSL_API
        WOLFSSL_EC_KEY
*
wolfSSL_d2i_ECPrivateKey(WOLFSSL_EC_KEY
**key,
const unsigned char **in,
long len
);
...
WOLFSSL_API
void wolfSSL_EC_KEY_set_conv_form(WOLFSSL_EC_KEY * eckey, int
form);
WOLFSSL_API
        point_conversion_form_t

wolfSSL_EC_KEY_get_conv_form(const WOLFSSL_EC_KEY *key);

WOLFSSL_API
        WOLFSSL_BIGNUM
*

wolfSSL_EC_POINT_point2bn(const WOLFSSL_EC_GROUP *group,
                          const WOLFSSL_EC_POINT *p,
                          int form,
...
wolfSSL_EC_KEY_get0_public_key(const WOLFSSL_EC_KEY *key);

WOLFSSL_API
const WOLFSSL_EC_GROUP
*

wolfSSL_EC_KEY_get0_group(const WOLFSSL_EC_KEY *key);
...
wolfSSL_EC_KEY_get0_private_key(const WOLFSSL_EC_KEY *key);

WOLFSSL_API
        WOLFSSL_EC_KEY
*

wolfSSL_EC_KEY_new_by_curve_name(int nid);
...
wolfSSL_EC_KEY_new_ex(void *heap, int devId);

WOLFSSL_API
        WOLFSSL_EC_KEY
*

wolfSSL_EC_KEY_new(void);
...
WOLFSSL_API
void wolfSSL_EC_KEY_set_asn1_flag(WOLFSSL_EC_KEY * key, int
asn1_flag);
WOLFSSL_API
...
WOLFSSL_API
void wolfSSL_EC_GROUP_set_asn1_flag(WOLFSSL_EC_GROUP * group, int
flag);
WOLFSSL_API
        WOLFSSL_EC_GROUP
*

wolfSSL_EC_GROUP_new_by_curve_name(int nid);
...
wolfSSL_EC_GROUP_dup(const WOLFSSL_EC_GROUP *src);
...
WOLFSSL_API
const WOLFSSL_EC_METHOD
*

wolfSSL_EC_GROUP_method_of(
...
wolfSSL_EC_POINT_new(const WOLFSSL_EC_GROUP *group);
