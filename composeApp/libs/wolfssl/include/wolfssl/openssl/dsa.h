...
wolfSSL_DSA_generate_parameters(int bits,
                                unsigned char *seed, int seedLen, int *counterRet,
                                unsigned long *hRet, WOLFSSL_BN_CB cb, void *CBArg);

WOLFSSL_API int wolfSSL_DSA_generate_parameters_ex(WOLFSSL_DSA * dsa, int
bits,
unsigned char *seed,
int seedLen,
int *counterRet,
...
WOLFSSL_API WOLFSSL_DSA_SIG
*

wolfSSL_DSA_SIG_new(void);
...
WOLFSSL_API WOLFSSL_DSA_SIG
*
wolfSSL_d2i_DSA_SIG(WOLFSSL_DSA_SIG
**sig,
...
wolfSSL_DSA_do_sign_ex(const unsigned char *digest,
