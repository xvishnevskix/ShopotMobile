...
WOLFSSL_API WOLFSSL_HMAC_CTX
*

wolfSSL_HMAC_CTX_new(void);
...
const void *key,
int keylen,
const WOLFSSL_EVP_MD *type, WOLFSSL_ENGINE
* e);
...
wolfSSL_HMAC_size(const WOLFSSL_HMAC_CTX *ctx);

WOLFSSL_API const WOLFSSL_EVP_MD
*

wolfSSL_HMAC_CTX_get_md(const WOLFSSL_HMAC_CTX *ctx);
