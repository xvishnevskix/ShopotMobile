...
WOLFSSL_ASN_API DNS_entry
*

AltNameNew(void *heap);
...
WOLFSSL_LOCAL int CheckCertSignaturePubKey(const byte *cert, word32 certSz,
                                           void *heap, const byte *pubKey, word32 pubKeySz,
                                           int pubKeyOID);
...
word32 type, word32
* oidSz);
WOLFSSL_LOCAL Signer
*

MakeSigner(void *heap);

WOLFSSL_LOCAL void FreeSigner(Signer * signer, void * heap);
WOLFSSL_LOCAL void FreeSignerTable(Signer * *table, int
rows,
void *heap
);
#ifdef WOLFSSL_TRUST_PEER_CERT
...
WOLFSSL_ASN_API int ToTraditional(byte * buffer, word32
length);
WOLFSSL_ASN_API int ToTraditional_ex(byte * buffer, word32
length,
word32 *algId
);
...
WOLFSSL_LOCAL int ToTraditionalEnc(byte * input, word32
sz,
const char *password,
int passwordSz, word32
* algId);
WOLFSSL_ASN_API int UnTraditionalEnc(byte * key, word32
keySz,
byte *out,
        word32
* outSz,
...
WOLFSSL_ASN_API int TraditionalEnc(byte * key, word32
keySz,
byte *out,
        word32
* outSz,
...
WOLFSSL_LOCAL int DecryptContent(byte * input, word32
sz,
const char *psw,
int pswSz
);
WOLFSSL_LOCAL int EncryptContent(byte * input, word32
sz,
byte *out, word32
* outSz,
const char *password,
...
WOLFSSL_LOCAL int wc_GetKeyOID(byte * key, word32
keySz,
const byte **curveOID,
        word32
* oidSz,
...
WOLFSSL_LOCAL int SetShortInt(byte * input, word32 * inOutIdx, word32
number,
word32 maxIdx
);
...
WOLFSSL_LOCAL word32
SetASNLength(word32
length,
byte *output
);
WOLFSSL_LOCAL word32
SetASNSequence(word32
len,
byte *output
);
WOLFSSL_LOCAL word32
SetASNOctetString(word32
len,
byte *output
);
WOLFSSL_LOCAL word32
...
SetAlgoID(int algoOID, byte *output, int type, int curveSz);

WOLFSSL_LOCAL int SetMyVersion(word32
version,
byte *output,
int header
);
...
SetOthername(void *name, byte *output);
...
#endif
WOLFSSL_LOCAL int FlattenAltNames(byte * output, word32
outputSz,
...
#endif
#ifndef NO_DSA
WOLFSSL_LOCAL int StoreDSAParams(byte * , word32 * ,
const mp_int*, const mp_int*,
const mp_int*);
#endif
