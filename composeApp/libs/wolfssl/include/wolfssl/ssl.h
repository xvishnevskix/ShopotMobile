...
WOLFSSL_API WOLFSSL_METHOD
*

wolfTLS_client_method_ex(void *heap);

WOLFSSL_API WOLFSSL_METHOD
*

wolfTLS_client_method(void);
...
wolfTLS_server_method_ex(void *heap);

WOLFSSL_API WOLFSSL_METHOD
*

wolfTLS_server_method(void);

#endif
WOLFSSL_API WOLFSSL_METHOD
*

wolfSSLv23_method_ex(void *heap);

WOLFSSL_API WOLFSSL_METHOD
*

wolfSSLv23_method(void);

#ifndef NO_WOLFSSL_CLIENT
WOLFSSL_API WOLFSSL_METHOD
*

wolfSSLv23_client_method_ex(void *heap);
...
wolfSSLv23_server_method_ex(void *heap);

WOLFSSL_API WOLFSSL_METHOD
*

wolfSSLv23_server_method(void);
...
wolfTLSv1_1_method_ex(void *heap);

WOLFSSL_API WOLFSSL_METHOD
*

wolfTLSv1_1_method(void);

#ifndef NO_WOLFSSL_CLIENT
WOLFSSL_API WOLFSSL_METHOD
*

wolfTLSv1_1_client_method_ex(void *heap);

WOLFSSL_API WOLFSSL_METHOD
*

wolfTLSv1_1_client_method(void);
...
wolfTLSv1_1_server_method_ex(void *heap);

WOLFSSL_API WOLFSSL_METHOD
*

wolfTLSv1_1_server_method(void);
...
wolfTLSv1_2_method_ex(void *heap);
...
wolfTLSv1_2_client_method_ex(void *heap);
...
wolfTLSv1_2_server_method_ex(void *heap);
...
WOLFSSL_API WOLFSSL_CTX
*
wolfSSL_CTX_new_ex(WOLFSSL_METHOD
* method,
void *heap
);
WOLFSSL_ABI WOLFSSL_API
...
WOLFSSL_API WOLFSSL_CTX
*
wolfSSL_get_SSL_CTX(WOLFSSL
* ssl);
WOLFSSL_API WOLFSSL_X509_VERIFY_PARAM
*
wolfSSL_CTX_get0_param(WOLFSSL_CTX
* ctx);
WOLFSSL_API WOLFSSL_X509_VERIFY_PARAM
*
wolfSSL_get0_param(WOLFSSL
* ssl);
...
WOLFSSL_API WOLFSSL
*
wolfSSL_write_dup(WOLFSSL
* ssl);
WOLFSSL_ABI WOLFSSL_API
int wolfSSL_set_fd(WOLFSSL * ssl, int
fd);
#ifdef WOLFSSL_DTLS
WOLFSSL_API int wolfSSL_set_dtls_fd_connected(WOLFSSL* ssl, int fd);
#endif
WOLFSSL_API int wolfSSL_set_write_fd(WOLFSSL * ssl, int
fd);
WOLFSSL_API int wolfSSL_set_read_fd(WOLFSSL * ssl, int
fd);

WOLFSSL_API char *wolfSSL_get_cipher_list(int priority);

WOLFSSL_API char *wolfSSL_get_cipher_list_ex(WOLFSSL * ssl, int
priority);
...
WOLFSSL_API int wolfSSL_get_cipher_suite_from_name(const char *name,
                                                   ...
                                                   unsigned char *cipherSuite, int *flags);
...
WOLFSSL_ABI WOLFSSL_API
int wolfSSL_read(WOLFSSL * ssl, void * data, int
sz);
WOLFSSL_API int wolfSSL_peek(WOLFSSL * ssl, void * data, int
sz);
WOLFSSL_ABI WOLFSSL_API
int wolfSSL_accept(WOLFSSL * ssl);
WOLFSSL_API int wolfSSL_CTX_mutual_auth(WOLFSSL_CTX * ctx, int
req);
WOLFSSL_API int wolfSSL_mutual_auth(WOLFSSL * ssl, int
req);
#ifdef WOLFSSL_TLS13
...
WOLFSSL_API int wolfSSL_recv(WOLFSSL * ssl, void * data, int
sz,
int flags
);

WOLFSSL_API void wolfSSL_CTX_set_quiet_shutdown(WOLFSSL_CTX * ctx, int
mode);
WOLFSSL_API void wolfSSL_set_quiet_shutdown(WOLFSSL * ssl, int
mode);

WOLFSSL_ABI WOLFSSL_API
int wolfSSL_get_error(WOLFSSL * ssl, int
ret);
...
WOLFSSL_ABI WOLFSSL_API
void wolfSSL_flush_sessions(WOLFSSL_CTX * ctx, long
tm);
WOLFSSL_API void wolfSSL_CTX_flush_sessions(WOLFSSL_CTX * ctx, long
tm);
...
WOLFSSL_ABI WOLFSSL_API
void wolfSSL_CTX_set_verify(WOLFSSL_CTX * ctx, int
mode,
...
WOLFSSL_API void wolfSSL_set_verify(WOLFSSL * ssl, int
mode,
VerifyCallback verify_callback
);
WOLFSSL_API void wolfSSL_set_verify_result(WOLFSSL * ssl, long
v);
...
WOLFSSL_API int wolfSSL_CTX_save_cert_cache(WOLFSSL_CTX * ctx,
const char *fname
);
WOLFSSL_API int wolfSSL_CTX_restore_cert_cache(WOLFSSL_CTX * ctx,
const char *fname
);
WOLFSSL_API int wolfSSL_CTX_memsave_cert_cache(WOLFSSL_CTX * ctx, void * mem, int
sz,
int *used
);
...
WOLFSSL_API int wolfSSL_CTX_set_cipher_list_bytes(WOLFSSL_CTX * ctx,
const byte *list,
const int listSz
);
WOLFSSL_API int wolfSSL_set_cipher_list_bytes(WOLFSSL * ssl,
const byte *list,
const int listSz
);
...
WOLFSSL_API void wolfSSL_dtls_set_using_nonblock(WOLFSSL * ssl, int
nonblock);
...
WOLFSSL_API void wolfSSL_dtls13_set_send_more_acks(WOLFSSL * ssl, int
value);
...
WOLFSSL_API int wolfSSL_dtls_set_peer(WOLFSSL * ssl, void * peer, unsigned int
peerSz);
...
WOLFSSL_API int wolfSSL_CTX_mcast_set_member_id(WOLFSSL_CTX * ctx, unsigned short
id);
WOLFSSL_API int wolfSSL_set_secret(WOLFSSL * ssl, unsigned short
epoch,
...
WOLFSSL_API int wolfSSL_mcast_read(WOLFSSL * ssl, unsigned short * id, void * data, int
sz);
WOLFSSL_API int wolfSSL_mcast_peer_add(WOLFSSL * ssl, unsigned short
peerId,
int sub
);
WOLFSSL_API int wolfSSL_mcast_peer_known(WOLFSSL * ssl, unsigned short
peerId);
...
*
wolfSSL_sk_X509_pop(WOLF_STACK_OF(WOLFSSL_X509)
* sk);
...
wolfSSL_sk_GENERAL_NAME_new(void *cmpFunc);

WOLFSSL_API int wolfSSL_sk_GENERAL_NAME_push(WOLFSSL_GENERAL_NAMES * sk,
                                             WOLFSSL_GENERAL_NAME * gn);
WOLFSSL_API WOLFSSL_GENERAL_NAME
*
wolfSSL_sk_GENERAL_NAME_value(
        WOLFSSL_STACK
* sk,
int i
);
...
WOLFSSL_API WOLFSSL_DIST_POINT
*

wolfSSL_DIST_POINT_new(void);
...
WOLFSSL_API void wolfSSL_AUTHORITY_INFO_ACCESS_pop_free(
        WOLF_STACK_OF(WOLFSSL_ACCESS_DESCRIPTION) * sk,
        void(*f)
(WOLFSSL_ACCESS_DESCRIPTION*));
WOLFSSL_API WOLFSSL_ACCESS_DESCRIPTION
*
wolfSSL_sk_ACCESS_DESCRIPTION_value(
        WOLFSSL_STACK
* sk,
int idx
);
...
WOLFSSL_API WOLF_STACK_OF(WOLFSSL_X509_EXTENSION)
*

wolfSSL_sk_X509_EXTENSION_new_null(void);

WOLFSSL_API WOLFSSL_ASN1_OBJECT
*

wolfSSL_ASN1_OBJECT_new(void);

WOLFSSL_API WOLFSSL_ASN1_OBJECT
*
wolfSSL_ASN1_OBJECT_dup(WOLFSSL_ASN1_OBJECT
* obj);
WOLFSSL_API void wolfSSL_ASN1_OBJECT_free(WOLFSSL_ASN1_OBJECT * obj);
WOLFSSL_API WOLFSSL_STACK
*

wolfSSL_sk_new_asn1_obj(void);
...
wolfSSL_sk_ASN1_OBJECT_pop(
        WOLF_STACK_OF(WOLFSSL_ASN1_OBJECT)
* sk);
...
WOLFSSL_API WOLFSSL_X509_EXTENSION
*
wolfSSL_sk_X509_EXTENSION_value(
        WOLF_STACK_OF(WOLFSSL_X509_EXTENSION)
* sk,
int idx
);
WOLFSSL_API int wolfSSL_set_ex_data(WOLFSSL * ssl, int
idx,
void *data
);
...
WOLFSSL_API int wolfSSL_set_rfd(WOLFSSL * ssl, int
rfd);
WOLFSSL_API int wolfSSL_set_wfd(WOLFSSL * ssl, int
wfd);
WOLFSSL_API void wolfSSL_set_shutdown(WOLFSSL * ssl, int
opt);
WOLFSSL_API int wolfSSL_set_session_id_context(WOLFSSL * ssl,
const unsigned char *id,
unsigned int len
);
...
wolfSSL_SESSION_new(void);

WOLFSSL_API WOLFSSL_SESSION
*

wolfSSL_SESSION_new_ex(void *heap);
...
WOLFSSL_API WOLFSSL_CIPHER
*
wolfSSL_get_current_cipher(WOLFSSL
* ssl);
...
wolfSSL_CIPHER_get_id(const WOLFSSL_CIPHER *cipher);
...
WOLFSSL_API const WOLFSSL_CIPHER
*
wolfSSL_get_cipher_by_value(word16
value);
...
WOLFSSL_API WOLFSSL_SESSION
*
wolfSSL_get1_session(WOLFSSL
* ssl);

WOLFSSL_API WOLFSSL_X509
*

wolfSSL_X509_new(void);

WOLFSSL_API WOLFSSL_X509
*
wolfSSL_X509_dup(WOLFSSL_X509
* x);
...
#else
WOLFSSL_API WOLFSSL_BIO
*
wolfSSL_BIO_new(WOLFSSL_BIO_METHOD
*);
#endif
...
WOLFSSL_API int wolfSSL_BIO_gets(WOLFSSL_BIO * bio, char * buf, int
sz);
...
WOLFSSL_API WOLFSSL_BIO
*
wolfSSL_BIO_next(WOLFSSL_BIO
* bio);
WOLFSSL_API WOLFSSL_BIO
*
wolfSSL_BIO_find_type(WOLFSSL_BIO
* bio,
int type
);
WOLFSSL_API int wolfSSL_BIO_read(WOLFSSL_BIO * bio, void * buf, int
len);
WOLFSSL_API int wolfSSL_BIO_write(WOLFSSL_BIO * bio,
const void *data,
int len
);
WOLFSSL_API WOLFSSL_BIO
*
wolfSSL_BIO_push(WOLFSSL_BIO
* top,
WOLFSSL_BIO *append
);
WOLFSSL_API WOLFSSL_BIO
*
wolfSSL_BIO_pop(WOLFSSL_BIO
* bio);
...
WOLFSSL_API void wolfSSL_BIO_set_callback(WOLFSSL_BIO * bio,
                                          wolf_bio_info_cb
callback_func);
WOLFSSL_API wolf_bio_info_cb
wolfSSL_BIO_get_callback(WOLFSSL_BIO
*bio);
...
WOLFSSL_API WOLFSSL_BIO_METHOD
*

wolfSSL_BIO_f_md(void);
...
wolfSSL_BIO_f_buffer(void);

WOLFSSL_API long wolfSSL_BIO_set_write_buffer_size(WOLFSSL_BIO * bio, long
size);
WOLFSSL_API WOLFSSL_BIO_METHOD
*

wolfSSL_BIO_f_ssl(void);

WOLFSSL_API WOLFSSL_BIO
*

wolfSSL_BIO_new_socket(int sfd, int flag);
...
wolfSSL_BIO_f_base64(void);

WOLFSSL_API void wolfSSL_BIO_set_flags(WOLFSSL_BIO * bio, int
flags);
WOLFSSL_API void wolfSSL_BIO_clear_flags(WOLFSSL_BIO * bio, int
flags);
WOLFSSL_API int wolfSSL_BIO_get_fd(WOLFSSL_BIO * bio, int * fd);
WOLFSSL_API int wolfSSL_BIO_set_ex_data(WOLFSSL_BIO * bio, int
idx,
void *data
);
#ifdef HAVE_EX_DATA_CLEANUP_HOOKS
    ...
    wolfSSL_ex_data_cleanup_routine_t cleanup_routine);
#endif
WOLFSSL_API void *wolfSSL_BIO_get_ex_data(WOLFSSL_BIO * bio, int
idx);
WOLFSSL_API long wolfSSL_BIO_set_nbio(WOLFSSL_BIO * bio, long
on);

WOLFSSL_API int wolfSSL_BIO_get_mem_data(WOLFSSL_BIO * bio, void * p);

WOLFSSL_API void wolfSSL_BIO_set_init(WOLFSSL_BIO * bio, int
init);
WOLFSSL_API void wolfSSL_BIO_set_data(WOLFSSL_BIO * bio, void * ptr);
WOLFSSL_API void *wolfSSL_BIO_get_data(WOLFSSL_BIO * bio);
WOLFSSL_API void wolfSSL_BIO_set_shutdown(WOLFSSL_BIO * bio, int
shut);
...
wolfSSL_BIO_meth_new(int type, const char *name);

WOLFSSL_API void wolfSSL_BIO_meth_free(WOLFSSL_BIO_METHOD * biom);
WOLFSSL_API int wolfSSL_BIO_meth_set_write(WOLFSSL_BIO_METHOD * biom, wolfSSL_BIO_meth_write_cb
biom_write);
WOLFSSL_API int wolfSSL_BIO_meth_set_read(WOLFSSL_BIO_METHOD * biom, wolfSSL_BIO_meth_read_cb
biom_read);
WOLFSSL_API int wolfSSL_BIO_meth_set_puts(WOLFSSL_BIO_METHOD * biom, wolfSSL_BIO_meth_puts_cb
biom_puts);
WOLFSSL_API int wolfSSL_BIO_meth_set_gets(WOLFSSL_BIO_METHOD * biom, wolfSSL_BIO_meth_gets_cb
biom_gets);
WOLFSSL_API int wolfSSL_BIO_meth_set_ctrl(WOLFSSL_BIO_METHOD * biom, wolfSSL_BIO_meth_ctrl_get_cb
biom_ctrl);
WOLFSSL_API int wolfSSL_BIO_meth_set_create(WOLFSSL_BIO_METHOD * biom, wolfSSL_BIO_meth_create_cb
biom_create);
...
wolfSSL_BIO_new_mem_buf(const void *buf, int len);

WOLFSSL_API long wolfSSL_BIO_set_ssl(WOLFSSL_BIO * b, WOLFSSL * ssl, int
flag);
WOLFSSL_API long wolfSSL_BIO_get_ssl(WOLFSSL_BIO * bio, WOLFSSL * *ssl);
#ifndef NO_FILESYSTEM
WOLFSSL_API long wolfSSL_BIO_set_fd(WOLFSSL_BIO * b, int
fd,
int flag
);
#endif
WOLFSSL_API int wolfSSL_BIO_set_close(WOLFSSL_BIO * b, long
flag);
...
wolfSSL_BIO_s_file(void);

WOLFSSL_API WOLFSSL_BIO
*

wolfSSL_BIO_new_fd(int fd, int close_flag);
...
wolfSSL_BIO_s_bio(void);

WOLFSSL_API WOLFSSL_BIO_METHOD
*

wolfSSL_BIO_s_socket(void);

WOLFSSL_API WOLFSSL_BIO
*

wolfSSL_BIO_new_connect(const char *str);

WOLFSSL_API WOLFSSL_BIO
*

wolfSSL_BIO_new_accept(const char *port);
...
WOLFSSL_API WOLFSSL_BIO
*
wolfSSL_BIO_new_ssl(WOLFSSL_CTX
* ctx,
int client
);
WOLFSSL_API WOLFSSL_BIO
*
wolfSSL_BIO_new_ssl_connect(WOLFSSL_CTX
* ctx);

WOLFSSL_API long wolfSSL_BIO_do_handshake(WOLFSSL_BIO * b);
WOLFSSL_API void wolfSSL_BIO_ssl_shutdown(WOLFSSL_BIO * b);

WOLFSSL_API long wolfSSL_BIO_ctrl(WOLFSSL_BIO * bp, int
cmd,
long larg,
void *parg
);
WOLFSSL_API long wolfSSL_BIO_int_ctrl(WOLFSSL_BIO * bp, int
cmd,
long larg,
int iarg
);

WOLFSSL_API int wolfSSL_BIO_set_write_buf_size(WOLFSSL_BIO * b, long
size);
...
WOLFSSL_API int wolfSSL_BIO_nread(WOLFSSL_BIO * bio, char * *buf, int
num);
WOLFSSL_API int wolfSSL_BIO_nwrite(WOLFSSL_BIO * bio, char * *buf, int
num);
WOLFSSL_API int wolfSSL_BIO_reset(WOLFSSL_BIO * bio);

WOLFSSL_API int wolfSSL_BIO_seek(WOLFSSL_BIO * bio, int
ofs);
WOLFSSL_API int wolfSSL_BIO_tell(WOLFSSL_BIO * bio);
WOLFSSL_API int wolfSSL_BIO_write_filename(WOLFSSL_BIO * bio, char * name);
WOLFSSL_API long wolfSSL_BIO_set_mem_eof_return(WOLFSSL_BIO * bio, int
v);
...
WOLFSSL_API WOLFSSL_COMP_METHOD
*

wolfSSL_COMP_zlib(void);

WOLFSSL_API WOLFSSL_COMP_METHOD
*

wolfSSL_COMP_rle(void);
...
WOLFSSL_API void wolfSSL_set_dynlock_lock_callback(void (*f)(int,
                                                             WOLFSSL_dynlock_value *, const char *,
                                                             int));
...
WOLFSSL_API void wolfSSL_X509_STORE_CTX_set_verify_cb(WOLFSSL_X509_STORE_CTX * ctx,
                                                      WOLFSSL_X509_STORE_CTX_verify_cb
verify_cb);
...
*
wolfSSL_d2i_X509_NAME(WOLFSSL_X509_NAME
**name,
unsigned char **in,
long length
);
...
#ifndef NO_BIO
WOLFSSL_API int wolfSSL_RSA_print(WOLFSSL_BIO * bio, WOLFSSL_RSA * rsa, int
offset);
#endif /* !NO_BIO */
#endif /* !NO_RSA */
...
WOLFSSL_API int wolfSSL_X509_ext_isSet_by_NID(WOLFSSL_X509 * x509, int
nid);
WOLFSSL_API int wolfSSL_X509_ext_get_critical_by_NID(WOLFSSL_X509 * x509, int
nid);
WOLFSSL_API int wolfSSL_X509_EXTENSION_set_critical(WOLFSSL_X509_EXTENSION * ex, int
crit);
...
WOLFSSL_API WOLFSSL_ASN1_TIME
*

wolfSSL_X509_get_notBefore(const WOLFSSL_X509 *x509);

WOLFSSL_API WOLFSSL_ASN1_TIME
*

wolfSSL_X509_get_notAfter(const WOLFSSL_X509 *x509);

WOLFSSL_API int wolfSSL_X509_set_serialNumber(WOLFSSL_X509 * x509,
                                              WOLFSSL_ASN1_INTEGER * s);
WOLFSSL_API int wolfSSL_X509_set_version(WOLFSSL_X509 * x509, long
v);
...
WOLFSSL_API WOLFSSL_ASN1_STRING
*
wolfSSL_X509_NAME_ENTRY_get_data(WOLFSSL_X509_NAME_ENTRY
* in);

WOLFSSL_API WOLFSSL_ASN1_STRING
*

wolfSSL_ASN1_STRING_new(void);

WOLFSSL_API WOLFSSL_ASN1_STRING
*
wolfSSL_ASN1_STRING_dup(WOLFSSL_ASN1_STRING
* asn1);
WOLFSSL_API WOLFSSL_ASN1_STRING
*

wolfSSL_ASN1_STRING_type_new(int type);

WOLFSSL_API int wolfSSL_ASN1_STRING_type(const WOLFSSL_ASN1_STRING *asn1);

WOLFSSL_API WOLFSSL_ASN1_STRING
*
wolfSSL_d2i_DISPLAYTEXT(WOLFSSL_ASN1_STRING
**asn,
...
WOLFSSL_API int
wolfSSL_X509_LOOKUP_add_dir(WOLFSSL_X509_LOOKUP *lookup, const char *dir, long type);

WOLFSSL_API int wolfSSL_X509_LOOKUP_load_file(WOLFSSL_X509_LOOKUP *lookup, const char *file,
                                              long type);

WOLFSSL_API WOLFSSL_X509_LOOKUP_METHOD
*

wolfSSL_X509_LOOKUP_hash_dir(void);

WOLFSSL_API WOLFSSL_X509_LOOKUP_METHOD
*

wolfSSL_X509_LOOKUP_file(void);

WOLFSSL_API int wolfSSL_X509_LOOKUP_ctrl(WOLFSSL_X509_LOOKUP *ctx, int cmd,
                                         const char *argc, long argl, char **ret);

WOLFSSL_API WOLFSSL_X509_LOOKUP
*
wolfSSL_X509_STORE_add_lookup(WOLFSSL_X509_STORE
* store,
WOLFSSL_X509_LOOKUP_METHOD *m
);
WOLFSSL_API WOLFSSL_X509_STORE
*

wolfSSL_X509_STORE_new(void);
...
wolfSSL_X509_STORE_CTX_get1_chain(
        WOLFSSL_X509_STORE_CTX
* ctx);
WOLFSSL_API WOLFSSL_X509_STORE_CTX
*
...
WOLFSSL_API int wolfSSL_X509_STORE_get_by_subject(WOLFSSL_X509_STORE_CTX * ctx,
                                                  int
idx,
WOLFSSL_X509_NAME *name, WOLFSSL_X509_OBJECT
* obj);
WOLFSSL_API WOLFSSL_X509_STORE_CTX
*

wolfSSL_X509_STORE_CTX_new(void);
...
WOLFSSL_API WOLFSSL_ASN1_TIME
*
wolfSSL_X509_CRL_get_lastUpdate(WOLFSSL_X509_CRL
* crl);
WOLFSSL_API WOLFSSL_ASN1_TIME
*
wolfSSL_X509_CRL_get_nextUpdate(WOLFSSL_X509_CRL
* crl);

WOLFSSL_API WOLFSSL_EVP_PKEY
*
wolfSSL_X509_get_pubkey(WOLFSSL_X509
* x509);
...
WOLFSSL_API WOLFSSL_PKCS8_PRIV_KEY_INFO
*
...
WOLFSSL_API WOLFSSL_EVP_PKEY
*
wolfSSL_d2i_PUBKEY_bio(WOLFSSL_BIO
* bio,
WOLFSSL_EVP_PKEY **out
);
WOLFSSL_API WOLFSSL_EVP_PKEY
*
wolfSSL_d2i_PUBKEY(WOLFSSL_EVP_PKEY
** key,
const unsigned char **in,
long inSz
);
...
wolfSSL_d2i_PublicKey(int type, WOLFSSL_EVP_PKEY **pkey,
                      const unsigned char **in, long inSz);

WOLFSSL_API WOLFSSL_EVP_PKEY
*

wolfSSL_d2i_PrivateKey(int type,
...
WOLFSSL_API WOLFSSL_EVP_PKEY
*
wolfSSL_d2i_PrivateKey_EVP(WOLFSSL_EVP_PKEY
** key,
unsigned char **in,
long inSz
);
...
WOLFSSL_API int wolfSSL_X509_load_cert_crl_file(WOLFSSL_X509_LOOKUP *ctx,
                                              const char *file, int type);
#endif
WOLFSSL_API WOLFSSL_X509_REVOKED
*
wolfSSL_X509_CRL_get_REVOKED(WOLFSSL_X509_CRL
* crl);
WOLFSSL_API WOLFSSL_X509_REVOKED
*
wolfSSL_sk_X509_REVOKED_value(
        WOLFSSL_X509_REVOKED
* revoked,
int value
);
WOLFSSL_API WOLFSSL_ASN1_INTEGER
*
wolfSSL_X509_get_serialNumber(WOLFSSL_X509
* x509);
WOLFSSL_API void wolfSSL_ASN1_INTEGER_free(WOLFSSL_ASN1_INTEGER * in);
WOLFSSL_API WOLFSSL_ASN1_INTEGER
*

wolfSSL_ASN1_INTEGER_new(void);
...
WOLFSSL_API int wolfSSL_ASN1_INTEGER_set(WOLFSSL_ASN1_INTEGER * a, long
v);
WOLFSSL_API WOLFSSL_ASN1_INTEGER
*
...
WOLFSSL_API WOLF_STACK_OF(WOLFSSL_X509_NAME)
*

wolfSSL_load_client_CA_file(const char *fname);
...
WOLFSSL_API void *wolfSSL_X509_STORE_CTX_get_ex_data(
        WOLFSSL_X509_STORE_CTX * ctx, int
idx);
...
WOLFSSL_API WOLFSSL_X509
*
wolfSSL_X509_STORE_CTX_get0_cert(
        WOLFSSL_X509_STORE_CTX
* ctx);
...
WOLFSSL_API wc_pem_password_cb
*
wolfSSL_CTX_get_default_passwd_cb(WOLFSSL_CTX
* ctx);
...
WOLFSSL_API WOLFSSL_RSA
*

wolfSSL_RSA_generate_key(int len, unsigned long e,
                         void(*f)(int, int, void *), void *data);

WOLFSSL_API WOLFSSL_RSA
*
wolfSSL_d2i_RSAPublicKey(WOLFSSL_RSA
**r,
...
WOLFSSL_API WOLFSSL_RSA
*
wolfSSL_d2i_RSAPrivateKey(WOLFSSL_RSA
** r,
...
WOLFSSL_API long wolfSSL_CTX_sess_set_cache_size(WOLFSSL_CTX * ctx, long
sz);
...
WOLFSSL_API int wolfSSL_set_read_ahead(WOLFSSL * ssl, int
v);
WOLFSSL_API int wolfSSL_CTX_get_read_ahead(WOLFSSL_CTX * ctx);
WOLFSSL_API int wolfSSL_CTX_set_read_ahead(WOLFSSL_CTX * ctx, int
v);
...
WOLFSSL_API int wolfSSL_CTX_set_srp_strength(WOLFSSL_CTX * ctx, int
strength);

WOLFSSL_API char *wolfSSL_get_srp_username(WOLFSSL * ssl);

WOLFSSL_API long wolfSSL_set_options(WOLFSSL * s, long
op);

WOLFSSL_API long wolfSSL_get_options(const WOLFSSL *s);

WOLFSSL_API long wolfSSL_clear_options(WOLFSSL * s, long
op);
...
WOLFSSL_API long wolfSSL_set_tlsext_status_type(WOLFSSL * s, int
type);
...
WOLFSSL_API long wolfSSL_set_tlsext_status_ocsp_resp(WOLFSSL * s, unsigned char * resp, int
len);
WOLFSSL_API int wolfSSL_set_tlsext_max_fragment_length
        (WOLFSSL * s, unsigned char
mode);
WOLFSSL_API int wolfSSL_CTX_set_tlsext_max_fragment_length
        (WOLFSSL_CTX * c, unsigned char
mode);
...
#ifndef NO_PSK
typedef unsigned int (*wc_psk_client_callback)(WOLFSSL * ssl,
const char*, char*,
...
WOLFSSL_API int wolfSSL_CTX_use_psk_identity_hint(WOLFSSL_CTX * ctx,
const char *hint
);
WOLFSSL_API int wolfSSL_use_psk_identity_hint(WOLFSSL * ssl,
const char *hint
);

typedef unsigned int (*wc_psk_server_callback)(WOLFSSL * ssl,
const char*,
...
WOLFSSL_API long wolfSSL_CTX_set_options(WOLFSSL_CTX * ctx, long
opt);
WOLFSSL_API long wolfSSL_CTX_get_options(WOLFSSL_CTX * ctx);
WOLFSSL_API long wolfSSL_CTX_clear_options(WOLFSSL_CTX * ctx, long
opt);
...
wolfSSL_CTX_get0_privatekey(const WOLFSSL_CTX *ctx);
...
WOLFSSL_API long wolfSSL_CTX_set_mode(WOLFSSL_CTX * ctx, long
mode);
WOLFSSL_API long wolfSSL_CTX_clear_mode(WOLFSSL_CTX * ctx, long
mode);
WOLFSSL_API long wolfSSL_CTX_get_mode(WOLFSSL_CTX * ctx);
WOLFSSL_API void wolfSSL_CTX_set_default_read_ahead(WOLFSSL_CTX * ctx, int
m);
...
const char *format,
        va_list
args);
WOLFSSL_API int wolfSSL_BIO_printf(WOLFSSL_BIO * bio,
const char *format, ...
);
...
WOLFSSL_API int wolfSSL_CTX_set_ex_data(WOLFSSL_CTX * ctx, int
idx,
void *data
);
#ifdef HAVE_EX_DATA_CLEANUP_HOOKS
...
WOLFSSL_ABI WOLFSSL_API
int wolfSSL_set_timeout(WOLFSSL * ssl, unsigned int
to);
WOLFSSL_ABI WOLFSSL_API
int wolfSSL_CTX_set_timeout(WOLFSSL_CTX * ctx, unsigned int
to);
WOLFSSL_API void wolfSSL_CTX_set_current_time_cb(WOLFSSL_CTX * ctx,
                                                 void(*cb)
(
const WOLFSSL *ssl, WOLFSSL_TIMEVAL
* out_clock));

/* get wolfSSL peer X509_CHAIN */
WOLFSSL_API WOLFSSL_X509_CHAIN
*
wolfSSL_get_peer_chain(WOLFSSL
* ssl);
...
/* index cert length */
WOLFSSL_API int wolfSSL_get_chain_length(WOLFSSL_X509_CHAIN * chain, int
idx);
/* index cert */
WOLFSSL_API unsigned char *wolfSSL_get_chain_cert(WOLFSSL_X509_CHAIN * chain, int
idx);
/* index cert in X509 */
WOLFSSL_API WOLFSSL_X509
*
wolfSSL_get_chain_X509(WOLFSSL_X509_CHAIN
* chain,
int idx
);
/* free X509 */
...
WOLFSSL_API int wolfSSL_get_chain_cert_pem(WOLFSSL_X509_CHAIN * chain, int
idx,
unsigned char *buf,
int inLen,
int *outLen
...
WOLFSSL_API int wolfSSL_X509_get_serial_number(WOLFSSL_X509 * x509, unsigned char * in,
                                               int * inOutSz);
...
WOLFSSL_API int wolfSSL_cmp_peer_cert_to_file(WOLFSSL * ssl,
const char *fname
);

WOLFSSL_ABI WOLFSSL_API
char *wolfSSL_X509_get_next_altname(WOLFSSL_X509 * cert);
WOLFSSL_API int wolfSSL_X509_add_altname_ex(WOLFSSL_X509 * x509,
const char *name, word32
nameSz,
int type
);
WOLFSSL_API int wolfSSL_X509_add_altname(WOLFSSL_X509 * x509,
const char *name,
int type
);
...
WOLFSSL_API WOLFSSL_X509_CRL
*
wolfSSL_d2i_X509_CRL(WOLFSSL_X509_CRL
**crl,
const unsigned char *in,
int len
);
WOLFSSL_API WOLFSSL_X509_CRL
*
wolfSSL_d2i_X509_CRL_bio(WOLFSSL_BIO
*bp,
WOLFSSL_X509_CRL **crl
);
#if !defined(NO_FILESYSTEM) && !defined(NO_STDIO_FILESYSTEM)
...
wolfSSL_X509_REVOKED_get0_serial_number(const
...
wolfSSL_X509_REVOKED_get0_revocation_date(const
                                          WOLFSSL_X509_REVOKED *rev);
...
WOLFSSL_API WOLFSSL_X509
*
wolfSSL_X509_d2i_fp(WOLFSSL_X509
** x509,
XFILE file
);
#endif
...
WOLFSSL_API WC_PKCS12
*
wolfSSL_d2i_PKCS12_bio(WOLFSSL_BIO
* bio,
WC_PKCS12 **pkcs12
);
WOLFSSL_API int wolfSSL_i2d_PKCS12_bio(WOLFSSL_BIO * bio, WC_PKCS12 * pkcs12);
#if !defined(NO_FILESYSTEM) && !defined(NO_STDIO_FILESYSTEM)
WOLFSSL_API WOLFSSL_X509_PKCS12
*
wolfSSL_d2i_PKCS12_fp(XFILE
fp,
...
WOLFSSL_X509 **cert,
        WOLF_STACK_OF(WOLFSSL_X509)
** ca);
WOLFSSL_API int wolfSSL_PKCS12_verify_mac(WC_PKCS12 * pkcs12,
const char *psw,
int pswLen
);
WOLFSSL_API WC_PKCS12
...
wolfSSL_PKCS12_create(char *pass, char *name,
...
WOLFSSL_API int wolfSSL_SetTmpDH(WOLFSSL * ssl,
const unsigned char *p,
int pSz,
const unsigned char *g,
int gSz
);
WOLFSSL_API int wolfSSL_SetTmpDH_buffer(WOLFSSL * ssl,
const unsigned char *b,
long sz,
int format
);
WOLFSSL_API int wolfSSL_SetEnableDhKeyTest(WOLFSSL * ssl, int
enable);
#ifndef NO_FILESYSTEM
WOLFSSL_API int wolfSSL_SetTmpDH_file(WOLFSSL * ssl,
const char *f,
int format
);
#endif
...
WOLFSSL_API int wolfSSL_CTX_SetTmpDH(WOLFSSL_CTX * ctx,
const unsigned char *p,
int pSz,
const unsigned char *g,
int gSz
);
WOLFSSL_API int wolfSSL_CTX_SetTmpDH_buffer(WOLFSSL_CTX * ctx,
const unsigned char *b,
long sz,
int format
);
...
#ifndef NO_FILESYSTEM
WOLFSSL_API int wolfSSL_CTX_SetTmpDH_file(WOLFSSL_CTX * ctx,
const char *f,
int format
);
#endif
...
keySz_bits);
WOLFSSL_API int wolfSSL_SetMinDhKey_Sz(WOLFSSL * ssl, word16
keySz_bits);
WOLFSSL_API int wolfSSL_CTX_SetMaxDhKey_Sz(WOLFSSL_CTX * ctx, word16
keySz_bits);
WOLFSSL_API int wolfSSL_SetMaxDhKey_Sz(WOLFSSL * ssl, word16
keySz_bits);
WOLFSSL_API int wolfSSL_GetDhKey_Sz(WOLFSSL * ssl);
#endif /* NO_DH */

#ifndef NO_RSA
WOLFSSL_API int wolfSSL_CTX_SetMinRsaKey_Sz(WOLFSSL_CTX * ctx, short
keySz);
WOLFSSL_API int wolfSSL_SetMinRsaKey_Sz(WOLFSSL * ssl, short
keySz);
#endif /* NO_RSA */
...
WOLFSSL_API int wolfSSL_SetTmpEC_DHE_Sz(WOLFSSL * ssl, word16
sz);
WOLFSSL_API int wolfSSL_CTX_SetTmpEC_DHE_Sz(WOLFSSL_CTX * ctx, word16
sz);
...
WOLFSSL_API int wolfSSL_make_eap_keys(WOLFSSL * ssl, void * key, unsigned int
len,
const char *label
);
...
WOLFSSL_API int wolfSSL_CTX_use_PrivateKey_Label(WOLFSSL_CTX * ctx,
const char *label,
int devId
);
...
/* SSL versions */
WOLFSSL_API int wolfSSL_use_certificate_buffer(WOLFSSL * ssl,
const unsigned char *in,
long sz,
int format
);
...
WOLFSSL_API int wolfSSL_use_PrivateKey_buffer(WOLFSSL * ssl,
const unsigned char *in,
long sz,
int format
);
WOLFSSL_API int wolfSSL_use_PrivateKey_id(WOLFSSL * ssl,
const unsigned char *id,
long sz,
int devId,
long keySz
...
WOLFSSL_API int wolfSSL_use_PrivateKey_Label(WOLFSSL * ssl,
const char *label,
int devId
);
...
WOLFSSL_API int wolfSSL_DTLS_SetCookieSecret(WOLFSSL * ssl,
const byte *secret, word32
secretSz);
...
WOLFSSL_ABI WOLFSSL_API
int wolfSSL_CTX_SetMinVersion(WOLFSSL_CTX * ctx, int
version);
WOLFSSL_API int wolfSSL_SetMinVersion(WOLFSSL * ssl, int
version);
...
WOLFSSL_API void wolfSSL_CTX_SetMacEncryptCb(WOLFSSL_CTX * ctx, CallbackMacEncrypt
cb);
...
WOLFSSL_API void wolfSSL_CTX_SetEncryptMacCb(WOLFSSL_CTX * ctx, CallbackEncryptMac
cb);
...
WOLFSSL_API const unsigned char *wolfSSL_GetMacSecret(WOLFSSL * ssl, int
verify);
WOLFSSL_API const unsigned char *wolfSSL_GetDtlsMacSecret(WOLFSSL * ssl, int
verify,
int epochOrder
);
...
#ifndef NO_CERTS
WOLFSSL_API void wolfSSL_CTX_SetCACb(WOLFSSL_CTX * ctx, CallbackCACache
cb);

WOLFSSL_API WOLFSSL_CERT_MANAGER
*
wolfSSL_CTX_GetCertManager(WOLFSSL_CTX
* ctx);

WOLFSSL_API WOLFSSL_CERT_MANAGER
*

wolfSSL_CertManagerNew_ex(void *heap);

WOLFSSL_API WOLFSSL_CERT_MANAGER
*

wolfSSL_CertManagerNew(void);
...
WOLFSSL_API int wolfSSL_EnableCRL(WOLFSSL * ssl, int
options);
...
WOLFSSL_API int wolfSSL_LoadCRLFile(WOLFSSL * ssl,
const char *file,
int type
);
...
WOLFSSL_API int wolfSSL_SetCRL_Cb(WOLFSSL * ssl, CbMissingCRL
cb);
#ifdef HAVE_CRL_IO
WOLFSSL_API int wolfSSL_SetCRL_IOCb(WOLFSSL* ssl, CbCrlIO cb);
#endif
WOLFSSL_API int wolfSSL_EnableOCSP(WOLFSSL * ssl, int
options);
WOLFSSL_API int wolfSSL_DisableOCSP(WOLFSSL * ssl);
WOLFSSL_API int wolfSSL_SetOCSP_OverrideURL(WOLFSSL * ssl,
const char *url
);
WOLFSSL_API int wolfSSL_SetOCSP_Cb(WOLFSSL * ssl, CbOCSPIO
ioCb,
CbOCSPRespFree respFreeCb,
void *ioCbCtx
);
...
WOLFSSL_API int wolfSSL_CTX_EnableCRL(WOLFSSL_CTX * ctx, int
options);
...
WOLFSSL_API int wolfSSL_CTX_LoadCRLFile(WOLFSSL_CTX * ctx,
const char *path,
int type
);
...
WOLFSSL_API int wolfSSL_CTX_SetCRL_Cb(WOLFSSL_CTX * ctx, CbMissingCRL
cb);
#ifdef HAVE_CRL_IO
WOLFSSL_API int wolfSSL_CTX_SetCRL_IOCb(WOLFSSL_CTX* ctx, CbCrlIO cb);
#endif

WOLFSSL_API int wolfSSL_CTX_EnableOCSP(WOLFSSL_CTX * ctx, int
options);
...
WOLFSSL_ABI WOLFSSL_API
int wolfSSL_SetDevId(WOLFSSL * ssl, int
devId);
WOLFSSL_ABI WOLFSSL_API
int wolfSSL_CTX_SetDevId(WOLFSSL_CTX * ctx, int
devId);
...
WOLFSSL_API int wolfSSL_SetHsDoneCb(WOLFSSL * ssl, HandShakeDoneCb
cb,
void *user_ctx
);
