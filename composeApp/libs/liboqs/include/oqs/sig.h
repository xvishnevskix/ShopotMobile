...
typedef struct OQS_SIG {
     ...
     */
    OQS_STATUS
    (*sign)(uint8_t *signature, size_t *signature_len, const uint8_t *message, size_t message_len,
     ...
     * @return OQS_SUCCESS or OQS_ERROR
     */
    OQS_STATUS (*verify)(const uint8_t *message, size_t message_len, const uint8_t *signature,
...
OQS_SIG_new(const char *method_name);
...
OQS_SIG_keypair(const OQS_SIG *sig, uint8_t *public_key, uint8_t *secret_key);
...
OQS_SIG_sign(const OQS_SIG *sig, uint8_t *signature, size_t *signature_len, const uint8_t *message,
...
OQS_SIG_verify(const OQS_SIG *sig, const uint8_t *message, size_t message_len,
